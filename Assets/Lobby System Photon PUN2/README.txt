...
//!!IMPORTANT!!///////////////////////////////
For joining lobby in photon, you must not erase "PhotonNetwork.JoinLobby();" in "Scripts->Photon->Connexion.cs" line 48.
...
Look Component "Connexion.cs" in "ConnexionPhoton" and change variable "MaxPlayer" in inspector by the desired number.
...
//!!LOGIN!!///////////////////////////////////
After clicked the "Button" to login panel with your pseudo, launches the command "OnLoginButtonClicked()" line 24 in "Connexion.cs" which 
launches the command line 32 "PhotonNetwork.ConnectUsingSettings();" for connect to Photon server and add your pseudo line 31 with "PhotonNetwork.LocalPlayer.NickName".
After you connected to Photon, launches automatically line 43 "OnConnectedToMaster()" which launches line 48 "PhotonNetwork.JoinLobby();" for joining automatically lobby.
...
As soon as you are logged in in the Lobby, launches automatically "OnJoinedLobby()" line 53 in "Connexion.cs" and with the command line 55
"Template.instance.BtnCreatRoom.interactable = true", unlock the button for "Create Room".




//!!CREATE ROOM!!/////////////////////////////
After clicked the "Create Room",  launches automatically command "OnCreateRoomButtonClicked()" in "Connexion.cs" line 65.
After create room, you automatically join the room and launches command automatically "OnJoinedRoom()" line 17 in "ListPlayer.cs".
...
After click button "LEAVE ROOM", launches command "OnLeaveGameButtonClicked()" to "Connexion.cs" line 80 and you exit the room with command 
"PhotonNetwork.LeaveRoom ();" line 82.
As soon exit room, launches automatically command "OnLeftRoom()" in "ListPlayer.cs" line 68 and launches "OnJoinedLobby()" line 81.
